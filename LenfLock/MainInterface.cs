...
namespace LenfLock {
    public partial class MainInterface : Form {
        ...
        private void init() {
            ...
            notifyIcon1.ContextMenu.MenuItems.Add("Exit", (x, e) => { FormClosing -= _Closing; Close(); });
        ...
        public void show(bool freeze = false) {
            if (instance.isShow == false) {
                (currentForm as QuestionForm).start(freeze);
            }
            lateShow.Stop();
        ...
        FormClosingEventHandler _Closing = (x, e) => e.Cancel = true;
    }
}